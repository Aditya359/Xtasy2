...
<div id="cl-wrapper" class="login-container">
	...
	<div class="middle-login">
		<div class="block-flat">
			<div class="header">
				<h3 class="text-center"><a href="/"><img class="logo-img" src="logo.png" alt="logo" height="150px" /></a></h3>
			</div>
			<div>
   ...
   You have successfully registered. </div>";
    ...
    <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>
     Your mail has been verified.</div>";
                  ...
                  echo "<div class=\"alert alert-warning\" role=\"alert\">Please check your email to verify your account.(Missing verification link ? check spam folder!)</div>";
                }
              }
